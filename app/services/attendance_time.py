...
def classify_checkin_status(
    ...
    base_date = work_date or vn_now.date()
    start_at = datetime.combine(base_date, shift_start_time, tzinfo=VN_TZ)
...
def classify_checkout_status(
    ...
    base_date = work_date or vn_now.date()
    end_at = datetime.combine(base_date, shift_end_time, tzinfo=VN_TZ)

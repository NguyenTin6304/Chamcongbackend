...
def build_reset_password_subject() -> str:
    return "Khôi phục mật khẩu - Attendance App"


def build_reset_password_text(payload: ResetPasswordMail) -> str:
    return (
        "Xin chào,\n\n"
        "Bạn vừa yêu cầu đặt lại mật khẩu cho tài khoản Attendance App.\n"
...
def build_reset_password_html(payload: ResetPasswordMail) -> str:
    return (
        "<p>Xin chào,</p>"
        "<p>Bạn vừa yêu cầu đặt lại mật khẩu cho tài khoản Attendance App.</p>"
